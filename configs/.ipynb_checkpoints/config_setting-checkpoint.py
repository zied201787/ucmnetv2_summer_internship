...
class setting_config:
    ...
    #work_dir = 'results/ultra__Monday_23_June_2025_17h_33m_28s/'
    """i change it becuase i want to start from the last chechk point"""
    #work_dir = 'results/ultra_training_run/'  # fixed path without date/time
    work_dir= "results/ultra__Wednesday_02_July_2025_13h_12m_04s"
    print_interval = 20
    val_interval = 30
    save_interval = 100
    threshold = 0.5
